  ...
  outputs = { self, nixpkgs }:
    let
      ...
      downloadUrl = {
        ...
        generic.sha256 = "1pc8cxzcxg942v5myfgdixidib5ajkad7vk64sw4h694vz80pjy4";
      };
    ...
    {
      packages."${system}" = {
        zen = mkZen { variant = "generic"; };
        specific = self.packages."${system}".zen;
        generic = self.packages."${system}".zen;
